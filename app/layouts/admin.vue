<template>
  <div class="min-h-screen bg-base-100">
    ...
    <div class="lg:pl-72">
      ...
      <div class=" lg:hidden sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-6 border-b border-base-300 bg-base-100 px-4 shadow-sm sm:px-6 lg:px-8">
          ...
          <div class="flex items-center">
            <div class="dropdown dropdown-end">
              ...
              <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                <li><NuxtLink to="/users/account">Account Settings</NuxtLink></li>
      ...
      <main>
        <!-- Sticky search header -->
    <div class="hidden sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-6 border-b border-base-300 bg-base-100 px-4 shadow-sm sm:px-6 lg:px-8">
      <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
        <form class="grid flex-1 grid-cols-1" @submit.prevent>
          <input
            name="search"
            aria-label="Search"
            class="input input-ghost col-start-1 row-start-1 w-full pl-10"
            placeholder="Search settings..."
          />
          <MagnifyingGlassIcon class="pointer-events-none col-start-1 row-start-1 h-5 w-5 self-center ml-3 opacity-50" aria-hidden="true" />
        </form>
      </div>
    </div>
        <slot />
