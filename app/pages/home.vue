  ...
  <div class="min-h-screen ">
    ...
    <nav class="navbar bg-base-100 shadow-lg sticky top-0 z-50 px-2 sm:px-4">
      ...
      <div class="navbar-end">
        <a class="btn btn-primary btn-sm sm:btn-md">Sign In</a>
      </div>
    </nav>
    ...
    <SectionsHero heading="Get rich results for your " :heading-rotate="['Recipes', 'How-Tos', 'Lists']"
      ...
      primary-button-text="Start Free" primary-button-link="#pricing" screenshot-src="/img/screenshots/rich-results.png"
          ...
          <div class="relative lg:col-span-3">
            ...
            <div
              ...
              <div class="p-10 pt-4">
                ...
                <p class="mt-2 text-lg font-medium tracking-tight text-base-content">Show up in search with eye-catching
                  cards</p>
                <p class="mt-2 max-w-lg text-sm/6 opacity-70">Your readers see beautiful recipe cards, star ratings, and
                  cooking times right in Google search results. <strong>How it works:</strong> We automatically generate
                  proper JSON-LD schema for every card you create.</p>
              </div>
            </div>
            <div
          ...
          <div class="relative lg:col-span-3">
            ...
            <div class="relative flex h-full flex-col overflow-hidden rounded-box lg:rounded-tr-[calc(2rem+1px)]">
              ...
              <div class="p-10 pt-4">
                ...
                <p class="mt-2 text-lg font-medium tracking-tight text-base-content">Give readers accurate nutrition
                  info</p>
                <p class="mt-2 max-w-lg text-sm/6 opacity-70">Save hours of manual work while helping health-conscious
                  readers make informed choices. <strong>How it works:</strong> Our free API calculates nutrition facts
          ...
          <div class="relative lg:col-span-2">
            ...
            <div class="relative flex h-full flex-col overflow-hidden rounded-box lg:rounded-bl-[calc(2rem+1px)]">
              ...
              <div class="p-10 pt-4">
                ...
                <p class="mt-2 text-lg font-medium tracking-tight text-base-content">Build trust with reader reviews</p>
                <p class="mt-2 max-w-lg text-sm/6 opacity-70">Let your audience share their success stories and help new
          ...
          <div class="relative lg:col-span-2">
            ...
            <div class="relative flex h-full flex-col overflow-hidden rounded-box">
              ...
              <div class="p-10 pt-4">
                ...
                <p class="mt-2 text-lg font-medium tracking-tight text-base-content">Readers scale recipes to their
                  needs</p>
                <p class="mt-2 max-w-lg text-sm/6 opacity-70">Your readers can cook for 2 or 20 without doing math. All
          ...
          <div class="relative lg:col-span-2">
            ...
            <div
              ...
              <div class="p-10 pt-4">
                ...
                <p class="mt-2 text-lg font-medium tracking-tight text-base-content">Earn with product recommendations
                </p>
                <p class="mt-2 max-w-lg text-sm/6 opacity-70">Help readers find the tools they need while earning
    ...
    <div class="bg-accent py-24 sm:py-32 px-6 sm:px-24">
      <div class="flex flex-col space-y-16 py-18 max-w-7xl rounded-xl bg-base-100 overflow-hidden mx-auto text-center font-light">
        ...
        <div class="flex flex-col gap-18 xl:gap-0 xl:flex-row justify-evenly">
          <!-- Free Forever -->
          <div class="px-3 flex-1">
            <div class="inline-flex items-center rounded-full bg-transparent px-4 py-1 text-sm font-semibold text-transparent mb-4" aria-hidden="true">
              Nothing here
            </div>
...
<div class="divider xl:divider-horizontal"></div>
    ...
    <div class="bg-base-100 py-16 sm:py-32 px-6">
      <div
        class="mx-auto py-16 px-20 flex space-x-12 max-w-5xl w-full bg-white dark:bg-base-200 text-base-content dark:ring-2 ring-3 ring-success rounded-3xl">
        <ExclamationCircleIcon class="h-14 w-14 shrink-0" />
        <div class="space-y-3 ">
          <p class="text-pretty font-serif text-md">
            <span class="block font-bold">How it works:</span>
            Interactive Mode is free with our ads, so you keep 100% of your site's ad revenue while giving readers an
            amazing experience at zero cost.
          </p>
          <p class="text-pretty font-serif text-md pb-8">
            The experience opens in an iframe, which lets us show our ads without affecting your exclusivity agreements
            or taking any of your ad revenue.
          </p>
          <p class="alert alert-success text-sm w-[80%] mx-auto">Want to use your own ads? Go Pro anytime to render
            in-page and boost your earnings with your ad network.</p>
        </div>
      </div>
    </div>
