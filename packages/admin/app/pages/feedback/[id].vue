...
const mailtoLink = computed(() => {
  ...
  const body = [
    ...
    ``,
    `Thanks for reporting the Create issue on ${r.site_name || 'your site'}! We're looking into it and will get back to you ASAP. Please let us know if you have any additional information or further issues.`,
    ``,
    `––`,
    `JM`,
    `Create Team`,
