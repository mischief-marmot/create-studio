...
// Set page meta
useHead({
  title: page.value?.title || 'Create Studio Documentation',
  meta: [
    { name: 'description', content: page.value?.description || 'Documentation for Create Studio' }
  ]
})
</script>
    ...
    <div class="max-w-8xl sm:px-2 lg:px-8 xl:px-12 relative flex justify-center flex-auto w-full mx-auto">
      ...
      <div class="lg:max-w-none lg:pr-0 lg:pl-8 xl:px-16 flex-auto max-w-2xl min-w-0 px-4 py-16">
        <article v-if="page">
          ...
          <div class="lg:prose-5xl prose-a:no-underline prose-a:hover:underline prose-zinc dark:prose-invert max-w-6xl prose prose-lg">
