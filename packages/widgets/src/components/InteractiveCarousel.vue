...
const requestTimerWarning = (callback: () => void) => {
    ...
    if (timerWarningModalRef.value) {
        ...
        console.error('❌ [InteractiveCarousel] timerWarningModalRef is null');
...
const handleTimerWarningAccept = () => {
    console.log('✅ [InteractiveCarousel] User accepted timer warning');
...
const handleTimerWarningDecline = () => {
    console.log('❌ [InteractiveCarousel] User declined timer warning');
    pendingTimerCallback.value = null;
};
