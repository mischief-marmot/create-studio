...
// Import all shared components that widgets may use
import RecipeTimer from '../../components/RecipeTimer.vue'
import RecipeMedia from '../../components/RecipeMedia.vue'
import StarRating from '../../components/StarRating.vue'
import ActiveTimers from '../../components/ActiveTimers.vue'
...
export class MountManager {
  ...
  async mount(context: MountContext): Promise<App | null> {
    ...
    try {
      ...
      // Register all shared components globally so they're available to all widgets
      app.component('RecipeTimer', RecipeTimer)
      app.component('RecipeMedia', RecipeMedia)
      app.component('StarRating', StarRating)
      app.component('ActiveTimers', ActiveTimers)
